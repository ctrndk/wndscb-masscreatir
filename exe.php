...
function loop($socks,$timeout) {
	...
	if (stripos($page, 'session_auth_hash')) {
		echo "SUCCESS | Email: ".$email." | Password: ".$password." | Username: ".$username."\n";
		$data =  "SUCCESS | Email: ".$email." | Password: ".$password." | Username: ".$username."\r\n";
...
echo "MASS WINDSCRIBE ACCOUNT CREATOR\n";
